...
struct Mock {
    ...
    static let gameRepo = GameRepo(gameId: "mockGameId", firstIsFirendly: true, friendlyBoard: sudokuBoard, enemyBoard: sudokuBoard, enemyData: userData, startTime: Timestamp.init())
}
